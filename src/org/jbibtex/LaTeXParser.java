...
public class LaTeXParser implements LaTeXParserConstants {
	 ...
	 */
        public List<LaTeXObject> parse(String string) throws ParseException, TokenMgrError {
	 ...
	 */
        public List<LaTeXObject> parse(Reader reader) throws ParseException, TokenMgrError {
                ReInit(reader);
